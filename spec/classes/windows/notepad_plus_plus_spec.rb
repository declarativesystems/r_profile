...
describe 'r_profile::windows::notepad_plus_plus' do
  ...
  # untestable due to https://tickets.puppetlabs.com/browse/MODULES-4287
  ...
  #   it { should contain_class('r_profile::windows::notepad_plus_plus') }
  # end
end
